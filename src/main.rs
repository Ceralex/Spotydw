...
use crate::parser::UrlType::Spotify;
use crate::parser::{parse_url, SoundCloudType, SpotifyType, UrlType};
    ...
    match subcommand.as_str() {
        ...
        "download" => {
            ...
            match url_type {
                    ...
                    match spotify_type {
                        SpotifyType::Track => {
                            ...
                            let video = videos
                                ...
                                .take(5)
                                .min_by_key(|&video| {
                                    video.duration_ms.wrapping_sub(track.duration_ms)
                                })
                                .unwrap();

                            let input_file = youtube::download(&yt_dlp_path, &video, None)
                                .map_err(|err| {
                ...
                UrlType::SoundCloud(soundcloud_type) => match soundcloud_type {
